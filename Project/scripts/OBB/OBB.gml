...
static dbug_draw = function(col=c_white) {
    ...
    // Bottom face
    vertex_point_add(vbuff, corners[0].x, corners[0].y, corners[0].z, col);
    vertex_point_add(vbuff, corners[1].x, corners[1].y, corners[1].z, col);
    vertex_point_add(vbuff, corners[1].x, corners[1].y, corners[1].z, col);
    vertex_point_add(vbuff, corners[2].x, corners[2].y, corners[2].z, col);
    vertex_point_add(vbuff, corners[2].x, corners[2].y, corners[2].z, col);
    vertex_point_add(vbuff, corners[3].x, corners[3].y, corners[3].z, col);
    vertex_point_add(vbuff, corners[3].x, corners[3].y, corners[3].z, col);
    vertex_point_add(vbuff, corners[0].x, corners[0].y, corners[0].z, col);

    // Top face
    vertex_point_add(vbuff, corners[4].x, corners[4].y, corners[4].z, col);
    vertex_point_add(vbuff, corners[5].x, corners[5].y, corners[5].z, col);
    vertex_point_add(vbuff, corners[5].x, corners[5].y, corners[5].z, col);
    vertex_point_add(vbuff, corners[6].x, corners[6].y, corners[6].z, col);
    vertex_point_add(vbuff, corners[6].x, corners[6].y, corners[6].z, col);
    vertex_point_add(vbuff, corners[7].x, corners[7].y, corners[7].z, col);
    vertex_point_add(vbuff, corners[7].x, corners[7].y, corners[7].z, col);
    vertex_point_add(vbuff, corners[4].x, corners[4].y, corners[4].z, col);
    ...
    vertex_point_add(vbuff, position.x - 1, position.y, position.z, col);
    vertex_point_add(vbuff, position.x + 1, position.y, position.z, col);
    vertex_point_add(vbuff, position.x, position.y - 1, position.z, col);
    vertex_point_add(vbuff, position.x, position.y + 1, position.z, col);
    vertex_point_add(vbuff, position.x, position.y, position.z - 1, col);
    vertex_point_add(vbuff, position.x, position.y, position.z + 1, col);
